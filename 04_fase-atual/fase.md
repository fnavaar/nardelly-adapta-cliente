...
- **Ambiente de construção: Skip (GoSkip + SkipCloud)** — regra geral do consultor (22/09); B-ENV-01 resolvido. F1-T01 depende apenas de autorização explícita de execução.
